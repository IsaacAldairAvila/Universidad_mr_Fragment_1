package com.example.mr_fragment_1;
...
public class FragmentAzul extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_azul, container, false);
        Button button = (Button) vista.findViewById(R.id.buttonclick);
